...
-- Started on 2013-10-28 18:26:18
...
--
-- TOC entry 166 (class 1259 OID 41318)
-- Name: cidade; Type: TABLE; Schema: public; Owner: hybridhashjoin; Tablespace: 
--
...
ALTER TABLE public.cidade OWNER TO hybridhashjoin;

--
-- TOC entry 165 (class 1259 OID 41316)
-- Name: cidade_id_seq; Type: SEQUENCE; Schema: public; Owner: hybridhashjoin
--
...
ALTER TABLE public.cidade_id_seq OWNER TO hybridhashjoin;

--
-- TOC entry 1928 (class 0 OID 0)
-- Dependencies: 165
-- Name: cidade_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hybridhashjoin
--
...
--
-- TOC entry 162 (class 1259 OID 41296)
-- Name: estado; Type: TABLE; Schema: public; Owner: hybridhashjoin; Tablespace: 
--
...
ALTER TABLE public.estado OWNER TO hybridhashjoin;

--
-- TOC entry 161 (class 1259 OID 41294)
-- Name: estado_id_seq; Type: SEQUENCE; Schema: public; Owner: hybridhashjoin
--
...
ALTER TABLE public.estado_id_seq OWNER TO hybridhashjoin;

--
-- TOC entry 1929 (class 0 OID 0)
-- Dependencies: 161
-- Name: estado_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hybridhashjoin
--
...
--
-- TOC entry 164 (class 1259 OID 41307)
-- Name: pais; Type: TABLE; Schema: public; Owner: hybridhashjoin; Tablespace: 
--
...
ALTER TABLE public.pais OWNER TO hybridhashjoin;

--
-- TOC entry 163 (class 1259 OID 41305)
-- Name: pais_id_seq; Type: SEQUENCE; Schema: public; Owner: hybridhashjoin
--
...
ALTER TABLE public.pais_id_seq OWNER TO hybridhashjoin;

--
-- TOC entry 1930 (class 0 OID 0)
-- Dependencies: 163
-- Name: pais_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: hybridhashjoin
--
...
--
-- TOC entry 1905 (class 2604 OID 41321)
-- Name: id; Type: DEFAULT; Schema: public; Owner: hybridhashjoin
--
...
--
-- TOC entry 1903 (class 2604 OID 41299)
-- Name: id; Type: DEFAULT; Schema: public; Owner: hybridhashjoin
--
...
--
-- TOC entry 1904 (class 2604 OID 41310)
-- Name: id; Type: DEFAULT; Schema: public; Owner: hybridhashjoin
--
...
--
-- TOC entry 1919 (class 0 OID 41318)
-- Dependencies: 166
-- Data for Name: cidade; Type: TABLE DATA; Schema: public; Owner: hybridhashjoin
--

COPY cidade (id, nome, id_estado) FROM stdin;
1	Afonso Cláudio	8
...
-- Dependencies: 165
-- Name: cidade_id_seq; Type: SEQUENCE SET; Schema: public; Owner: hybridhashjoin
--
...
--
-- TOC entry 1915 (class 0 OID 41296)
-- Dependencies: 162
-- Data for Name: estado; Type: TABLE DATA; Schema: public; Owner: hybridhashjoin
--

COPY estado (id, nome, uf, pais) FROM stdin;
1	Acre	AC	1
2	Alagoas	AL	1
3	Amazonas	AM	1
4	Amapá	AP	1
...
-- Dependencies: 161
-- Name: estado_id_seq; Type: SEQUENCE SET; Schema: public; Owner: hybridhashjoin
--
...
--
-- TOC entry 1917 (class 0 OID 41307)
-- Dependencies: 164
-- Data for Name: pais; Type: TABLE DATA; Schema: public; Owner: hybridhashjoin
--

COPY pais (id, nome, sigla) FROM stdin;
1	Brasil	BR
\.
...
-- Dependencies: 163
-- Name: pais_id_seq; Type: SEQUENCE SET; Schema: public; Owner: hybridhashjoin
--
...
--
-- TOC entry 1911 (class 2606 OID 41326)
-- Name: cidade_pkey; Type: CONSTRAINT; Schema: public; Owner: hybridhashjoin; Tablespace: 
--
...
--
-- TOC entry 1907 (class 2606 OID 41304)
-- Name: estado_pkey; Type: CONSTRAINT; Schema: public; Owner: hybridhashjoin; Tablespace: 
--
...
--
-- TOC entry 1909 (class 2606 OID 41315)
-- Name: pais_pkey; Type: CONSTRAINT; Schema: public; Owner: hybridhashjoin; Tablespace: 
--
...
--
-- TOC entry 1913 (class 2606 OID 41327)
-- Name: cidade_id_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: hybridhashjoin
--

ALTER TABLE ONLY cidade
    ADD CONSTRAINT cidade_id_estado_fkey FOREIGN KEY (id_estado) REFERENCES estado(id);


--
-- TOC entry 1912 (class 2606 OID 41332)
-- Name: estado_pais_fkey; Type: FK CONSTRAINT; Schema: public; Owner: hybridhashjoin
--

ALTER TABLE ONLY estado
    ADD CONSTRAINT estado_pais_fkey FOREIGN KEY (pais) REFERENCES pais(id);
...
-- Completed on 2013-10-28 18:26:18
